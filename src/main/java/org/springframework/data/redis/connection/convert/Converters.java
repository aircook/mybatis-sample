 ...
 * copy class from spring-data-redis-3.2.0.jar to handle - RedisSystemException: Cannot read Redis info. Malformed \\uxxxx encoding.
 *
...
public abstract class Converters {
    ...
    public static Properties toProperties(String source) {
        ...
        //prevent Malformed \\uxxxx encoding, --> \(역슬러쉬) 가 문제
        try (StringReader stringReader = new StringReader(StringUtils.replace(source, "\\", "/"))) {
